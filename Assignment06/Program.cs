...
namespace Assignment06
{
    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //if (Range == "march to may")
            //{
            //    Console.WriteLine(Seasons.Spring);
            //}
            //else if (Range == "june to august")
            //{
            //    Console.WriteLine(Seasons.Summer);
            //}
            //else if (Range == "September to November")
            //{
            //    Console.WriteLine(Seasons.Autumn);
            //}
            //else if (Range == " December to February")
            //{
            ...
            //static double Distance(Point.Point01 point01, Point.Point01 point02)
            //{
            //    return Math.Sqrt(Math.Pow(point01.X - point02.X, 2) + Math.Pow(point01.Y - point02.Y, 2));
            //}
